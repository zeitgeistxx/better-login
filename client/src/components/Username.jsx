...
import { deleteCookie, getCookies, setCookie } from '../helper/APIcalls'
    ...
    <div className='container mx-auto'>
      ...
      <div className='flex justify-center items-center h-screen'>
        ...
        <div className={darkMode ? styles.darkGlass : styles.glass}>
          ...
          <div className='title flex flex-col items-center' id={darkMode ? styles.darkModeText : ''}>
          ...
          <div className='flex justify-center'>
            <button className={darkMode ? styles.darkModeBtn : styles.btn} style={{ position: 'absolute' }} onClick={googleAuth}>Sign in with Google</button>
          </div>
        </div>
